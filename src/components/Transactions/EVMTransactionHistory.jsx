                      ...
                      <div className={`text-xs ${isContractMode ? 'text-green-400/60 bg-green-600/5 border-green-600/20' : 'text-blue-400/60 bg-blue-600/5 border-blue-600/20'} p-3 rounded-lg border`}>
                        ...
                        {isContractMode ? (
                          <>
                            ...
                            <p>• Transaction hashes link directly to Push Chain Explorer for verification</p>
                            <p>• Complete transaction history is stored on-chain</p>
                          </>
                        ) : (
                          <>
                            <p>• Push Chain uses public RPC endpoints for optimal performance</p>
                            <p>• Detailed transaction history is available on Push Chain Explorer</p>
